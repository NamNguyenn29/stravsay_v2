...
import type { NewSupportRequest } from "@/model/NewSupportRequest";
        ...
        <div className="grid grid-cols-12 mt-10">
          <div className="col-span-6 text-xl text-sky-950">
            {setting && setting.status === 1 ? (
              <>
                <div className="mb-3">{setting.address}</div>
                <div className="mb-3">Phone: {setting.contactPhone}</div>
                <div>Email : {setting.contactEmail}</div>
              </>
            ) : (
              <div className="text-gray-500">Contact info unavailable</div>
            )}
          </div>
