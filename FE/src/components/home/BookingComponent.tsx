...
export default function BookingComponent({ rooms = [], loading = false }: BookingProps) {
                            ...
                            <div className="col-span-3 mt-[10[px]]">
                                <Carousel autoplay>
                                    {room.imageUrl.map((url, index) => (
                                        ...
                                        <div key={index}>
                                            <Image src={url} alt='' width={250} height={150} unoptimized
                        ...
                        <div className="grid grid-cols-12">
                            <div className="col-span-6 my-10">
                                ...
                                <div className="mb-5">
                                    ...
                                    <span className="ml-2">Breakfast : <b>{room.hasBreakFast ? "Include" : "No Include"}</b></span>
                                </div>
                                <div className="mb-5">
